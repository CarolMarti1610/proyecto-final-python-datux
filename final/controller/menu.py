...
def menu(app:App):
    ...
    while True:
        ...
        menu_text.append("[3] 📈 Reporte de detalle de Ventas por País\n", style="blue")
        ...
        opcion = Prompt.ask("[bold yellow]Selecciona una opción[/bold yellow]", choices=["1", "2", "3", "4"], default="3")
        ...
        if opcion == "1":
            ...
            pais = input("Indique el pais a consultar: ")
            reporte = ObtenerReporte(app, pais)
            # Aquí puedes llamar a una función para generar el reporte
        elif opcion == "4":
            pass
